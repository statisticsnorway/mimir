...
class Header extends React.Component {
  ...
  toggleSubMenu(index) {
    ...
    if (window && window.innerWidth >= 992 && document.activeElement instanceof HTMLElement) document.activeElement.blur()
  ...
  render() {
    const {
      searchText, mainMenuText, logoUrl, logoSrc, logoAltText, mainNavigation, skipToContentText, language, searchResult
    } = this.props
