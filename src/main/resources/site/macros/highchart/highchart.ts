...
export function macro(context: XP.MacroContext<HighchartConfig>): Response {
  try {
    ...
    const highchart: Response = highchartControllerPreview(context.request, config.highchart)
