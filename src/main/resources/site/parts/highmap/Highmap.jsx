...
const plotOptions = (hasThreshhold, props) => {
  return {
    map: {
      allAreas: false,
      joinBy: 'capitalName',
...
function Highmap(props) {
  ...
  const mapOptions = {
    ...
    legend: legend(props, y),
    plotOptions: plotOptions(hasThreshhold, props),
    series,
    credits: {
      enabled: false,
    },
    exporting: exporting(props),
    csv: {
      itemDelimiter: ';',
    },
  }
